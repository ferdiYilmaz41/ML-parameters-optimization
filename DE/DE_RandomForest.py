    ...
    while t < num_iterations:
        ...
        for i in range(population_size):
            ...
            if population[id_1]['n_estimators'] + mutation_factor * (population[id_2]['n_estimators'] - population[id_3]['n_estimators']) > 1:
                mutant_sol['n_estimators'] = population[id_1]['n_estimators'] + mutation_factor * (population[id_2]['n_estimators'] - population[id_3]['n_estimators'])
            if population[id_1]['max_depth'] + mutation_factor * (population[id_2]['max_depth'] - population[id_3]['max_depth']) > 1:
                mutant_sol['max_depth'] = population[id_1]['max_depth'] + mutation_factor * (population[id_2]['max_depth'] - population[id_3]['max_depth'])
            if population[id_1]['min_samples_split'] + mutation_factor * (population[id_2]['min_samples_split'] - population[id_3]['min_samples_split']) > 2:
                mutant_sol['min_samples_split'] = population[id_1]['min_samples_split'] + mutation_factor * (population[id_2]['min_samples_split'] - population[id_3]['min_samples_split'])
            if population[id_1]['min_samples_leaf'] + mutation_factor * (population[id_2]['min_samples_leaf'] - population[id_3]['min_samples_leaf']) > 1:
                mutant_sol['min_samples_leaf'] = population[id_1]['min_samples_leaf'] + mutation_factor * (population[id_2]['min_samples_leaf'] - population[id_3]['min_samples_leaf'])
